...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/screenshot/最大公约数.png" title="最大公约数" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/screenshot/求组合数 I.png" title="求组合数 I" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

### 知识点

- $\mathrm{C}_{a}^{b} = \mathrm{C}_{a-1}^{b}+\mathrm{C}_{a-1}^{b-1}$
